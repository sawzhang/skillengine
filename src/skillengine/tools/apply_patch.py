...
class ApplyPatchTool(BaseTool):
    ...
    def description(self) -> str:
        return (
            ...
            "Each diff line must strictly match [+-<space>]line format. "
            "'-' and ' ' entries must contain one complete line after the prefix. "
            "Multiple [+-<space>]line entries must be separated by '\\n'. "
