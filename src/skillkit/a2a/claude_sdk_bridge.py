"""Claude Agent SDK Bridge — run SkillKit Skills via Claude Agent SDK.

Enables dual-mode execution:
- Mode 1: SkillKit's native AgentRunner (own agent loop)
...
class ClaudeSDKBridge:
    """Bridge SkillKit Skills to Claude Agent SDK execution.
