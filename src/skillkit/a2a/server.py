"""A2A Server — expose SkillKit agents as A2A endpoints.
...
class A2AServer:
    """Expose SkillKit Skills as A2A-compatible HTTP endpoints.

    Usage::

        from skillkit import SkillsEngine, SkillsConfig
        from skillkit.a2a import AgentRegistry
